SELECT 'WLRS' ministry_code
     ...
     , projects.project_id application_id
     ...
     , CASE  
       ...
       WHEN 'IL' THEN 'Y'
       WHEN 'Not_IL' THEN 'N'             
       ELSE 'Unknown' END indigineous_led_ind
     , CASE  
       SUBSTR(projects.project_description
...
SELECT prj.PROJECT_ID 
 ...
 WHERE prj.PROJECT_ID = pt.project_id
   ...
   AND prj.PROJECT_STATUS_CODE In (1,2) 
   AND pt.PROJECT_TYPE_CODE = 682) projects
